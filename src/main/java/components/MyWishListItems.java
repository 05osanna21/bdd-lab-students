...
public class MyWishListItems {
    ...
    public MyWishListItems(WebElement image, String productName, String model, String stock,
                           String unitPrice, WebElement addToCartButton, WebElement removeButton) {
        this.image = image;
